...
const messages: Record<'en' | 'zh', Record<ErrorMessageKey, string>> = {
  zh: {
  ...
  en: {
    ...
    invalidFileType: 'Only JPEG, PNG, GIF, and WebP images are supported',
    fileSizeTooLarge: 'File size cannot exceed 10MB',
    fileAccessDenied: 'Access denied to this file',
  },
};

export async function getErrorMessage(key: ErrorMessageKey): Promise<string> {
